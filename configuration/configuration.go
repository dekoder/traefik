...
type GlobalConfiguration struct {
	...
	SendAnonymousUsage        bool              `description:"Periodically send anonymous usage statistics" export:"true"`
	OCSPStapling              bool              `description:"Enables OCSP stapling" export:"true"`
